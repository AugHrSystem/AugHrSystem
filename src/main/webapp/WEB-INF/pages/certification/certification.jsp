...
// 	            },
		...
		$("div.toolbar").html('<b><button type="button" id="addBtnCer" class="btn btn-warning" data-toggle="modal" data-target="#addModal"><spring:message code="label.newRecord"/></button>  </b>');
