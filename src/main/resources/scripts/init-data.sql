...
INSERT INTO EMP_OFFICIAL(OFFICIAL_DATE,START_WORK_DATE,END_WORK_DATE,POSITION_APPLIED_FOR,SALARY_EXPECTED,PROBATION_DATE) VALUES (NOW(),'2010-03-04',NOW(),'Sa',50000.00,NOW());
...
VALUES (NOW(),NOW(),'Programmer',30000.00,NOW(),'2013-02-02'),
	   (NOW(),NOW(),'Sa',40000.00,NOW(),'2014-07-02');
 

--EMPLOYEE
INSERT INTO EMP_EMPLOYEE (EMPLOYEE_CODE,NAME_THAI,NAME_ENG,TEL_HOME,TEL_MOBILE,EMERGENCY_CONTACT,
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,EMAIL,LOCATION_ID,EMPLOYMENT_ID) VALUES
('TH2009188','Bill','Bill',0811111111,0822222222,'Mom',191,'1991-01-01',12345678,1,1,1,'bill@gmail.com',1,1);

INSERT INTO EMP_EMPLOYEE (EMPLOYEE_CODE,NAME_THAI,NAME_ENG,TEL_HOME,TEL_MOBILE,EMERGENCY_CONTACT,
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,EMAIL,LOCATION_ID,EMPLOYMENT_ID,AIM_EMP_ID) VALUES
('TH2009189','Parn','Parn',0800000000,0899999999,'Dad',191,'1992-02-02',12345678,2,2,1,'parn@gmail.com',2,2,1);

INSERT INTO EMP_EMPLOYEE (EMPLOYEE_CODE,NAME_THAI,NAME_ENG,TEL_HOME,TEL_MOBILE,EMERGENCY_CONTACT,
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,EMAIL,EMPLOYMENT_ID,AIM_EMP_ID,OFFICIAL_ID,LOCATION_ID) VALUES
('TH2009190','test','test',0800000000,0899999999,'Dad',191,'1992-02-02',12345678,2,2,1,'test@gmail.com',2,1,2,2);

INSERT INTO EMP_EMPLOYEE (EMPLOYEE_CODE,NAME_THAI,NAME_ENG,TEL_HOME,TEL_MOBILE,EMERGENCY_CONTACT,
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,EMAIL,EMPLOYMENT_ID) VALUES
('TH2009191','test01','test01',0800000000,0899999999,'Dad',191,'1992-02-02',12345678,2,2,1,'test01@gmail.com',2);
...
--LEAVE
INSERT INTO EMP_LEAVE(START_DATE,END_DATE,REASON,LEAVETYPE_ID,EMPLOYEE_ID,AIM,START_TIME,END_TIME)
VALUES('2014-03-01','2014-03-04','sick',1,2,'1','09:00:00','14:00:00'),
('2014-07-01','2014-07-02','sick',1,2,'1','09:00:00','14:00:00'),
('2014-04-01','2014-04-03','sick',3,2,'1','09:00:00','14:00:00'),
('2014-02-01','2014-02-02','sick',4,2,'1','09:00:00','14:00:00');
