...
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,auditFlag,createdBy,createdTimeStamp) VALUES
('TH2009188','Bill','Bill',0811111111,0822222222,'Mom',191,'1991-01-01',12345678,1,1,'C',0,NOW()),
('TH2009189','Parn','Parn',0800000000,0899999999,'Dad',191,'1992-02-02',12345678,2,2,'C',0,NOW());




--EDUCATION
INSERT INTO EMP_EDUCATION (UNIVERSITY,GPA,FACULTY,MAJOR,EMPLOYEE_ID,DEGREETYPE_ID) VALUES 
('Silpakorn',4.00,'SCIENCE','IT',2,1);
...
--REWARD
INSERT INTO EMP_REWARD(NAME,YEAR,EMPLOYEE_ID)
VALUES('nobel','1991',2);
