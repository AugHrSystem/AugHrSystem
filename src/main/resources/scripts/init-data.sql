...
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID) VALUES
('TH2009188','Bill','Bill',0811111111,0822222222,'Mom',191,'1991-01-01',12345678,1,1,3),
('TH2009189','Parn','Parn',0800000000,0899999999,'Dad',191,'1992-02-02',12345678,2,2,3);




--EDUCATION
INSERT INTO EMP_EDUCATION (UNIVERSITY,GPA,FACULTY,MAJOR,EMPLOYEE_ID,DEGREETYPE_ID,CERTIFICATE,DESCRIPTION) VALUES 
('Silpakorn',4.00,'SCIENCE','IT',2,1,'JAVA','JAVA');
