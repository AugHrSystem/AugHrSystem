...
--OFFICIAL
INSERT INTO EMP_OFFICIAL(OFFICIAL_DATE,START_WORK_DATE,END_WORK_DATE,POSITION_APPLIED_FOR,SALARY_EXPECTED,PROBATION_DATE) VALUES (NOW(),NOW(),NOW(),'Programmer',30000.00,NOW());
...
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,EMAIL,LOCATION_ID,EMPLOYMENT_ID,OFFICIAL_ID) VALUES
('TH2009188','Bill','Bill',0811111111,0822222222,'Mom',191,'1991-01-01',12345678,1,1,1,'bill@gmail.com',1,1,1);
>>>>>>> show image and init edit
...
INSERT INTO EMP_EMPLOYEE (EMPLOYEE_CODE,NAME_THAI,NAME_ENG,TEL_HOME,TEL_MOBILE,EMERGENCY_CONTACT,
<<<<<<< HEAD
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,EMAIL,LOCATION_ID,EMPLOYMENT_ID,AIM_EMP_ID,official_id) VALUES
('TH2009188','Bill','Bill',0811111111,0822222222,'Mom',191,'1991-01-01',12345678,1,1,1,'bill@gmail.com',1,1,1,1),
('TH2009189','Parn','Parn',0800000000,0899999999,'Dad',191,'1992-02-02',12345678,2,2,1,'parn@gmail.com',2,2,1,null);

=======
EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,ID_CARD,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,EMAIL,LOCATION_ID,EMPLOYMENT_ID,OFFICIAL_ID,AIM_EMP_ID) VALUES
('TH2009188','Bill','Bill',0811111111,0822222222,'Mom',191,'1991-01-01',12345678,1,1,1,'bill@gmail.com',1,1,1,1);
...
VALUES('2014-03-01','2014-03-04','sick',1,2,'Parn'),
('2014-07-01','2014-07-02','sick',1,2,'Parn'),
('2014-04-01','2014-04-03','sick',3,2,'Parn'),
('2014-02-01','2014-02-02','sick',4,2,'Parn');
=======
--ADDRESS
