 ...
 * > When using Spring MVC for REST, how do you enable Jackson to pretty-print rendered JSON?</a> and the latest <a
 * href="https://gist.github.com/2423129">Spring Framework incarnation supporting pretty printing</a> (not yet released
...
public class DefaultJacksonHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
	 ...
	 * <p/>
	 * <p>
	 * Default implementation returns {@link org.codehaus.jackson.map.type.TypeFactory#type(java.lang.reflect.Type)},
	 * but this can be overridden in subclasses, to allow for custom generic collection handling. For instance:
	 * 
	 * <pre class="code">
	...
	/**
	 * Sets the {@code ObjectMapper} for this view. If not set, a default {@link ObjectMapper#ObjectMapper()
