...
public class FamilyController {
	...
	public String initEmpFamily(Locale locale,
		...
		List<Family> familyList = familyService.findByEmployeeId(2L);
	...
	public @ResponseBody FamilyDto Add(Locale locale,
		...
		emp = familyService.findEmployeeById(2L);
		...
		Family empFamilyforId = new Family();
		
		
		empFamilyforId = familyList.get(familyList.size()-1);
		
		
		Family familyObj = new Family();
		familyObj = familyService.findLastEmpFamily(empFamilyforId.getId());
		FamilyDto familyDto = new FamilyDto();
		familyDto.setId(familyObj.getId());
		familyDto.setFirstName(familyObj.getFirstName());
		familyDto.setLastName(familyObj.getLastName());
	...
	public @ResponseBody FamilyDto initEdit(Locale locale,
        ...
        Family familyEdit = familyService.findLastEmpFamily(new Integer(id));
        Hibernate.initialize(familyEdit.getEmployee());
	...
	public @ResponseBody FamilyDto Edit(Locale locale,
		...
		Family familyObj = new Family();
		familyObj = familyService.findLastEmpFamily(family.getId());	
		...
		Family familySetDto = familyService.findLastEmpFamily(family.getId());
		FamilyDto familyDto = new FamilyDto();
	...
	public @ResponseBody String Delete(Locale locale,
        ...
        Family familyDelete = familyService.findLastEmpFamily(new Integer(id));
